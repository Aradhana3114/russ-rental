<footer class="bg-cream border-t border-brand/10 pt-16 pb-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <p class="text-sm text-brand-dark/60 leading-relaxed">
                    Layanan rental mobil terpercaya dengan pilihan mobil berkualitas untuk kebutuhan perjalanan Anda di seluruh Indonesia.
                </p>
            ...
            <div>
                <h4 class="font-semibold text-brand-dark mb-4">Layanan Kami</h4>
                <ul class="space-y-2 text-sm text-brand-dark/60">
                    <li><a href="{{ route('services') }}" class="hover:text-brand">Daftar Mobil</a></li>
                    <li><a href="{{ route('services') }}" class="hover:text-brand">Rental Korporat</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-brand">Syarat & Ketentuan</a></li>
                </ul>
            </div>

            <div>
                <h4 class="font-semibold text-brand-dark mb-4">Lokasi Kami</h4>
                <ul class="space-y-2 text-sm text-brand-dark/60">
                    <li>Jakarta: Gedung SCBD, Jl. Jend. Sudirman, Jakarta Selatan</li>
                    <li>Bali: Jl. Kayu Aya, Seminyak, Bali</li>
                </ul>
            </div>

            <div>
                <h4 class="font-semibold text-brand-dark mb-4">Hubungi Kami</h4>
                <ul class="space-y-2 text-sm text-brand-dark/60">
                    <li>
                        <a href="https://wa.me/6285186669860" target="_blank" class="hover:text-brand">WhatsApp: +62 851-8666-9860</a>
                    </li>
                    <li>info@russrental.com</li>
                </ul>
        ...
        <div class="mt-12 pt-6 border-t border-brand/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-brand-dark/50">
            ...
            <div class="flex gap-5">
                <a href="{{ route('privacy') }}" class="hover:text-brand">Kebijakan Privasi</a>
                <a href="{{ route('terms') }}" class="hover:text-brand">Ketentuan Sewa</a>
                <a href="{{ route('insurance') }}" class="hover:text-brand">Asuransi</a>
            </div>
        </div>
    </div>
</footer>
